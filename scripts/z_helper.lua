...
local function var_0_56(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4, arg_17_5, arg_17_6, arg_17_7, arg_17_8)
	...
	surface.draw_filled_rect(arg_17_0, arg_17_1, arg_17_2, arg_17_8, arg_17_4, arg_17_5, arg_17_6, arg_17_7)
	surface.draw_filled_rect(arg_17_0, arg_17_1 + arg_17_3 - arg_17_8, arg_17_2, arg_17_8, arg_17_4, arg_17_5, arg_17_6, arg_17_7)
	surface.draw_filled_rect(arg_17_0, arg_17_1 + arg_17_8, arg_17_8, arg_17_3 - arg_17_8 * 2, arg_17_4, arg_17_5, arg_17_6, arg_17_7)
	surface.draw_filled_rect(arg_17_0 + arg_17_2 - arg_17_8, arg_17_1 + arg_17_8, arg_17_8, arg_17_3 - arg_17_8 * 2, arg_17_4, arg_17_5, arg_17_6, arg_17_7)
end
...
client.set_event_callback("paint", function()
	old_font = surface_createfont("Verdana", 13)
end)
...
local function var_0_196(arg_130_0)
	...
	if var_0_192 then
		cvar.sensitivity:set_raw_float(var_0_192 == 0 and tonumber(cvar.sensitivity:get_string()) or var_0_192)
					...
					if var_131_47 ~= nil then
						...
						if var_131_37.distance_width_mp > 0 then
							...
							for iter_131_12 = 1, #var_131_51 do
								...
								local surface_text = tostring(helper_datas_chinese[string.upper(var_131_108)] or var_131_108) or var_131_108
								local width, height = surface.get_text_size(old_font, surface_text)

								surface.draw_filled_rect(var_131_109 - 32, var_131_110 - 7, width + 40, height + 12, 0, 0, 0, 70)
								surface.draw_text(var_131_109, var_131_110, var_131_103, var_131_104, var_131_105, var_131_106, old_font, surface_text)
					...
					if var_131_136.viewangles_target ~= nil then
						...
						if var_131_145 ~= nil then
							...
							if var_131_165 > 1 then
								surface.draw_filled_rect(var_131_168 + var_131_165 - 4 * var_131_4, var_131_169 + 1, 3, var_131_160 - 1, var_131_161, var_131_162, var_131_163, var_131_24 * var_131_150 * var_131_136.on_screen_mp)
							end

							local surface_name = tostring(helper_datas_chinese[string.upper(var_131_136.name)] or var_131_136.name) or var_131_136.name
							local width, height = surface.get_text_size(old_font, surface_name)
							surface.draw_filled_rect(var_131_168+var_131_165 - 32, var_131_167 - 5, width + 40, height + 10, 0, 0, 0, 70)

							surface.draw_text(var_131_168 + var_131_165, var_131_167, var_131_161, var_131_162, var_131_163, var_131_24 * var_131_150, old_font, surface_name)

							if var_131_152 ~= nil then
								surface.draw_text(var_131_168 + var_131_165, var_131_167 + var_131_154, math.min(255, var_131_161 * 1.2), math.min(255, var_131_162 * 1.2), math.min(255, var_131_163 * 1.2), var_131_24 * var_131_150 * 0.92, old_font, var_131_152)
							end
						end
					end
				end
...
local function var_0_201(arg_133_0, arg_133_1, arg_133_2)
	...
	if var_0_190 == nil then
		...
		if (var_133_2 == "Legit" or var_133_2 == "Off") and cvar.sensitivity:get_float() > 0 then
			var_0_192 = cvar.sensitivity:get_float()
...
local function var_0_202(arg_136_0, arg_136_1, arg_136_2)
	...
	if var_136_8 ~= "Rage" then
		...
		if cvar.sensitivity:get_float() > 0 then
			var_0_192 = cvar.sensitivity:get_float()
